...
extension orangeClientDataView: UITableViewDataSource {
...
extension orangeClientDataView: UITableViewDelegate {
                ...
                handler:{
                    ...
                    do{
                        ...
                        for item in results{
                            ...
                            if thisClient.name == self.nameArr[indexPath.row].name{
...
extension orangeClientDataView: UISearchResultsUpdating {
